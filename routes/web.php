...
use App\Http\Controllers\NivauxController;
...
use App\Http\Controllers\FacturesdafController;
...
Route::group([
    'middleware' => 'App\Http\Middleware\Auth',
        ...
        Route::get('/nivauxs/list', [NivauxController::class, 'list'])->name('nivauxs.list');
        ...
        Route::resource('/nivauxs', NivauxController::class);
