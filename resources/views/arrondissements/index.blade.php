...
@push('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
                ...
                "columnDefs": [{
                    ...
                    "render": function(data, type, row) {
                        ...
                        return '<a href=' + url_e +
                            ...
                            '<div class="btn btn-danger delete btn_delete_arrondissement btn-sm ml-1" title="Supprimer" data-href=' +
            ...
            $('#table-arrondissements').off('click', '.btn_delete_arrondissement').on('click', '.btn_delete_arrondissement',
                function() {
                    var href = $(this).data('href');
                    $('#form-delete-arrondissement').attr('action', href);
                    $('#modal_delete_arrondissement').modal();
                });
        });
    </script>
@endpush
