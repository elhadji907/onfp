                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div align="right">
                                <a href="{{ route('agerouteformations.create') }}">
                                    ...
                                    @foreach ($projets->findividuelles as $findividuelle)
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-baseline text-center-row">
                                                ...
                                                &nbsp;
                                                {!! Form::open(['method' => 'DELETE', 'url' => 'agerouteformations/' . $findividuelle->formation->id, 'id' => 'deleteForm', 'onsubmit' => 'return ConfirmDelete()']) !!}
